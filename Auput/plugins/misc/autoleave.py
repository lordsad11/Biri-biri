...
from Auput.core.call import Auput, autoend
from Auput.utils.database import get_client, is_active_chat, is_autoend
                    ...
                    async for i in client.get_dialogs():
                        if i.chat.type in [
                            ...
                            if (
                                ...
                                and i.chat.id != -1002054986459
                                and i.chat.id != -1001670334318
                            ):
                                if left == 20:
                                    continue
